...
def kuwahara_filter_hsv(src, dst, v, window_size):
    ...
    # if min_std == std1:
    #     for rx1 in range(tidx - window_size + 1, tidx + 1): 
    #         for ry1 in range(tidy - window_size + 1, tidy + 1): 
    #             if rx1 >= 0 and ry1 >= 0 and rx1 < h and ry1 < w:
    #                 avg_r += src[rx1, ry1, 0]
    #                 avg_g += src[rx1, ry1, 1]
    #                 avg_b += src[rx1, ry1, 2]
    ...
    #         for ry2 in range(tidy - window_size + 1, tidy + 1): 
    #             if rx2 >= 0 and ry2 >= 0 and rx2 < h and ry2 < w:
    #                 avg_r += src[rx2, ry2, 0]
    #                 avg_g += src[rx2, ry2, 1]
    #                 avg_b += src[rx2, ry2, 2]
    #     avg_r = avg_r / ((window_size) * (window_size))
    # elif min_std == std3:
    #     for rx3 in range(tidx - window_size + 1, tidx + 1): 
    ...
    # dst[tidx, tidy, 0] = avg_r
    # dst[tidx, tidy, 1] = avg_g
    # dst[tidx, tidy, 2] = avg_b
